...
// ReqResp api-mode package, "bundle" variant (single self-contained bundle.js).
...
function handler(req, res) {
  ...
  if (route === '/sum') {
    ...
    result = { op: 'echo', message: `hello ${p.name || 'world'} from reqresp api (bundle)`, variant: 'bundle', route };
  }
